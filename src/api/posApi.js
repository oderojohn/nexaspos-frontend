...
export const posApi = {
  ...
  settleCustomerCredit: (id, amount, method = 'cash', extra = {}) => request(`/customers/${id}/settle-credit/`, { method: 'POST', body: JSON.stringify({ amount, method, ...extra }) }),
  ...
  customerCreditHistory: (id) => request(`/customers/${id}/credit-history/`),

...
const menuStructure = [
  ...
  { path: '/pos', icon: FaShoppingCart, ...ROUTE_POLICIES['/pos'] },
  {
    ...
    submenu: [
      ...
      { path: '/sales-control/customers', icon: FaUsers, ...ROUTE_POLICIES['/sales-control/customers'] },
  ...
  },
  {
    ...
    submenu: [
      ...
      { path: '/admin/credit-loyalty', icon: FaMoneyBillWave, ...ADMIN_ROUTE_POLICIES['/admin/credit-loyalty'] },
